...
//     useEffect(() => {
//         const currentProfession = professionBox[professionIndex];
//         let charIndex = 0;
...
//             <div className="absolute w-full top-32 z-10">
//                 <div className="grid gap-5 place-items-center text-white">
//                     <h1 className="text-5xl font-semibold text-shadow-[0px_0px_5px_white]">
//                         Hi, I'm <span className="text-[crimson] font-bold">MT GAMERS</span>
//                     </h1>
//                     <h3 className="flex items-center gap-3 text-4xl font-bold text-shadow-[0px_0px_5px_white]">
//                         I'm a <span className="text-[crimson] flex">
//                             {displayText}
//                             <span ref={cursor} className="animate-[pulse_1s_ease_infinite]">|</span>
//                         </span>
//                     </h3>
//                 </div>
//             </div>
