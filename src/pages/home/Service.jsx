    ...
    return (
        <section className="bg-neutral-800 w-screen py-20">
            ...
            <div className="flex flex-wrap items-center justify-center gap-3 mt-5 mx-auto">
                <div className="w-70 h-83 border-2 border-white bg-[repeating-linear-gradient(45deg,#702130,transparent_100px)] rounded-md py-3 px-5">
                    <h3 className="text-2xl text-center pb-1 font-extrabold text-[#cbcbcb]">Videos</h3>
                ...
                <div className="w-70 h-83 border-2 border-white bg-[repeating-linear-gradient(45deg,#702130,transparent_100px)] rounded-md py-3 px-5">
                    <h3 className="text-2xl text-center pb-1 font-extrabold text-[#cbcbcb]">Live Stream</h3>
                ...
                <div className="w-70 h-83 border-2 border-white bg-[repeating-linear-gradient(45deg,#702130,transparent_100px)] rounded-md py-3 px-5">
                    <h3 className="text-2xl text-center pb-1 font-extrabold text-[#cbcbcb]">Competition</h3>
                ...
                <div className="w-70 h-83 border-2 border-white bg-[repeating-linear-gradient(45deg,#702130,transparent_100px)] rounded-md py-3 px-5">
                    <h3 className="text-2xl text-center pb-1 font-extrabold text-[#cbcbcb]">Giveaway</h3>
